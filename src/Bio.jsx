...
export const Bio = () => {
  ...
  return (
    <div className='ResponsiveBio col-8' style={{ fontFamily: 'RedHatDisplay-Medium', color: '#000000', textAlign: "justify" }}>
      <div className="bio-header">
        <h2 style={{ fontFamily: 'RedHatDisplay-Bold', marginBottom: '1rem', color: '#000000' }}>About Me</h2>
      </div>
      ...
      <div className="skills-section mt-4 mb-3">
        <h3 style={{ fontFamily: 'RedHatDisplay-Bold', color: '#000000' }}>Skills</h3>
      ...
      <div className="bio-contact" style={{ fontFamily: 'RedHatDisplay-Regular', color: '#000000' }}>
